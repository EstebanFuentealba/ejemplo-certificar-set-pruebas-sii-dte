...
public class CookieManager {
     ...
     */
    public boolean  storeCookies(URLConnection conn) throws IOException {
    ...
    public String toString() {
        ...
        Iterator it = ((HashMap<String,Map>)store.get("sii.cl")).entrySet().iterator();
        StringBuffer sb = new StringBuffer();
        while(it.hasNext()) {
            Map.Entry entry = (Entry) it.next();
            sb.append(entry.getKey()+"="+ ((Map)entry.getValue()).get(entry.getKey())+"; ");
        }
        return sb.toString();
