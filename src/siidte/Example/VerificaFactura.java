...
public class VerificaFactura {
	...
	public static void main(String[] args) throws Exception {
        ...
        public static void DO(String facturaFile) throws FileNotFoundException, XmlException, IOException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidKeyException, SignatureException {
            // Meto el namespace en caso que no exista
		HashMap<String, String> namespaces = new HashMap<String, String>();
		namespaces.put("", "http://www.sii.cl/SiiDte");
		XmlOptions opts = new XmlOptions();
		...
		VerifyResult resl = doc.getDTE().verifyTimbre();
                System.out.println(resl.getCode());
		if (!resl.isOk()) {
			System.out.println("Documento: Timbre Incorrecto: "
					+ resl.getMessage());
		} else {
